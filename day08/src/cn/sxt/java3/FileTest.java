...
public class FileTest {
    ...
    public void test1(){
        ...
        File file2 =  new File("/Users/xiexu/sgg-workspace_idea/JavaSenior/day08/he.txt");

        System.out.println(file1);
        System.out.println(file2);

        //构造器2：parent表示的是上一级文件目录，child表示下一级的文件目录
        File file3 = new File("/Users/xiexu","JavaSeniors");
        System.out.println(file3);

        //构造器3： "/Users/xiexu/JavaSeniors/hi.txt"
    ...
    public void test2(){
        ...
        File file2 = new File("/Users/xiexu/sgg-workspace_idea/JavaSenior/day08/hi.txt");
    ...
    @Test
    public void test3(){ //要求文件目录一定得存在
        File file = new File("/Users/xiexu/sgg-workspace_idea/JavaSenior");
    ...
    public void test5(){
        ...
        File file2 = new File("/Users/xiexu/sgg-workspace_idea/JavaSenior/day08");
        file2 = new File("/Users/xiexu/sgg-workspace_idea/JavaSenior/day08");
     ...
     *             如果上层文件目录不存在，一并创建
     *        总结：如果要创建目录的上层目录都存在，则使用mkdir和mkdirs没有任何区别
     */
    @Test
    public void test7(){
        //文件目录的创建
        File file1 = new File("/Users/xiexu/sgg-workspace_idea/JavaSenior/io/io1/io3");
        ...
        File file2 = new File("/Users/xiexu/sgg-workspace_idea/JavaSenior/io/io1/io4");
