...
//        s1.delete(2,4); //[2,4)  ab1
//        s1.replace(2,4,"hello");  //把[2,4)这个区间的内容换成"hello"
//        s1.insert(2,false); //abfalsec11,相当于在索引2的地方插入，c往后移
//        s1.reverse();  //11cba
        String s2 = s1.substring(1, 3); //[1,3),截取这个区间的内容，"bc"
        System.out.println(s1); //abc11
